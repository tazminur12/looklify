...
export default function EditBlogPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/blogs?limit=1000')
      ...
      .then(json => {
        if (json.success) {
          setBlogs(json.data.blogs.filter(b => b._id !== id) || []);
        }
      })
        ...
        .then(json => {
          if (json.success) {
            ...
            setForm({
              ...
              featuredImage: blog.featuredImage || { url: '', publicId: '', alt: '' },
              ...
              relatedPosts: blog.relatedPosts?.map(p => p._id || p) || [],
    ...
    try {
      ...
      if (json.success) {
        ...
        Swal.fire({
          icon: 'error',
          title: 'Update Failed',
          text: json.error || 'Failed to update blog',
          confirmButtonText: 'Try Again'
        });
      }
    } catch (e) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Edit Blog</h1>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-1">Edit blog post</p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <RichTextEditor
                ...
                placeholder="Update the blog with the formatting toolbar above."
              />
